            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <a href="inputjurusita.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Juru Sita</button></a>
                  <div class="x_content">
                  <div class="x_content">
                             <?php
                              include '../koneksi/koneksi.php';
                              $sql1  		= "SELECT * FROM tb_jurusita LEFT JOIN tb_wilayah ON tb_jurusita.id_wilayah=tb_wilayah.id_wilayah order by id_js asc";                        
                              $query1  	= mysqli_query($db, $sql1);
                              $total		= mysqli_num_rows($query1);
                              if ($total == 0) {
                                echo"<center><h2>Belum Ada Data Juru Sita</h2></center>";
                              }
                              else{?>
                    <table id="datatable" class="table table-striped table-bordered" style="background-color: #0a210e42;">
                      <thead>
                        <tr>
                          <th width="15%">Nama Juru Sita</th>
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <a href=editjurusita.php?id_js='.$data['id_js'].'><button type="button" title="Edit" class="btn btn-success btn-xs"><i class="fa  fa-edit"></i></button></a>
                              <a onclick="return konfirmasi()" href="proses/proses_hapusjurusita.php?id_js='.$data['id_js'].'"><button type="button" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a></td>
                              </tr>';
                            }
                            ?>
                      </tbody>
