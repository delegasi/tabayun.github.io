          ...
          <div class="">
            <div class="page-title">
              <div class="title_right">
                <h2>KETERANGAN > <small>Data KETERANGAN</small></h2>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data ><small> KETERANGAN</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <a href="inputketerangan.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> TAMBAH KETERANGAN</button></a>
                  <div class="x_content">
                  <div class="x_content">
                             <?php
                              include '../koneksi/koneksi.php';
                              $sql1  		= "SELECT * FROM tb_keterangan order by id_ket desc";                        
                              $query1  	= mysqli_query($db, $sql1);
                              $total		= mysqli_num_rows($query1);
                              if ($total == 0) {
                                echo"<center><h2>Belum Ada Data Keterangan/h2></center>";
                              }
                              else{?>
                    <table id="datatable" class="table table-striped table-bordered" style="background-color: #0a210e42;">
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <a href=editketerangan.php?id_ket='.$data['id_ket'].'><button type="button" title="Edit" class="btn btn-success btn-xs"><i class="fa  fa-edit"></i></button></a>
                              <a onclick="return konfirmasi()" href="proses/proses_hapusketerangan.php?id_ket='.$data['id_ket'].'"><button type="button" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a></td>
                              </tr>';
                            }
                            ?>
                      </tbody>
