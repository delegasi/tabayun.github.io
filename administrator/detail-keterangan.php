                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <h3 align="center"><?php echo $data['nama_wilayah']?></h3>
                      <br />
                    </div>
                    ...
                    <table class="table table-striped" style="background-color: #0a210e42;">
                      <tbody>
                        <tr>
                          <td width="50%">ID</td>
                          <td><?php echo $data['id_wilayah']?></td>
                        </tr>
                        <tr>
                   ...
                   <a href="datawilayah.php" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a></div>
                  </div>
