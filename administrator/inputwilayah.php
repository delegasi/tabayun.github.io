                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form action="proses/proses_inputwilayah.php"  name="formbagian" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" >NAMA WILAYAH <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input type="text" id="kapital" name="nama_wilayah" required="required"  placeholder="MASUKAN WILAYAH" class="form-control col-md-7 col-xs-12" onkeyup="myFunction()">
                                                </div>
                                            </div>
