        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">SIMORETA <br><br><span class="logo-dec">PENGADILAN AGAMA MAJALENGKA</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="administrator/login"><i class="fa fa-sign-out pull-right"></i> Admin</a></li> 
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="logo">
		            <img src="template/img/majalengka.png" alt="" />
	            </div>
              <!-- <h3 class="bnr-sub-title">ARSIP DIGITAL DELEGASI</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">PENGADILAN AGAMA MAJALENGKA</span></h3> -->
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Delegasi Pengadilan Agama Majalengka</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-2 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="template/img/inbox.png">
              </div>
          ...
          <div class="col-md-2 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="template/img/outbox.png">
              </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="template/img/wulan.jpg" class="img-responsive">
              <figcaption>
                  <h2>WULANSARI</h2>
                  <p>"CPNS ANGKATAN XII - 2021"</p>
        ...
        <div class="row">
          <div class="testimonial-item">
            <ul class="bxslider">
              <li>
                <blockquote>
                  <img src="template/img/Grafikartes-Flat-Retro-Modern-Maps.ico" class="img-responsive">
    ...
    <!-- <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; WULANSARI 2021. All Rights Reserved.</p>
          <div class="credits"> -->
            <!-- 
