...
$excelku->getActiveSheet()->setCellValue('A3', "PENGADILAN AGAMA MAJALENGKA");
...
$excelku->getActiveSheet()->setCellValue('A5', "Jl. Kesuma Bangsa No. 1, Kota majalengka, Jawa Barat ");
