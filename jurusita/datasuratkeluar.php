                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query)){
                              ...
                              <a href= ../administrator/surat_keluar/'.$data['file_suratkeluar'].'><button type="button" title="Unduh File" class="btn btn-success btn-xs"><i class="fa fa-download"></i></button></a>
