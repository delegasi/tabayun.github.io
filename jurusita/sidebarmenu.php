            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-file-text"></i> Kategori Delegasi <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="datasuratmasuk.php"><i class="fa  fa-inbox"></i>Delegasi Masuk</a></li>
                      <li><a href="datasuratkeluar.php"><i class="fa fa-send"></i>Delegasi Keluar</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-search"></i> Cek Nomor <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="ceknomor.php"><i class="fa fa-laptop"></i>Nomor Delegasi Keluar</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
